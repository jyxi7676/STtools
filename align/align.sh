...
paste ${outprefix}'Solo.out/Velocyto/raw/spliced.mtx' ${outprefix}'Solo.out/Velocyto/raw/unspliced.mtx' ${outprefix}'Solo.out/Velocyto/raw/ambiguous.mtx' | awk 'FNR > 3 {print $1,$2,$3,$6,$9}' > ${outprefix}'Solo.out/Velocyto/raw/comb.mtx'
head -3 ${outprefix}'Solo.out/Velocyto/raw/spliced.mtx' > ${outprefix}'Solo.out/Velocyto/raw/header.txt' 
cat ${outprefix}'Solo.out/Velocyto/raw/header.txt' ${outprefix}'Solo.out/Velocyto/raw/comb.mtx' > ${outprefix}'Solo.out/Velocyto/raw/matrix.mtx'
