...
parser.add_argument("-m", "--mtx", type=str, default="matrix.mtx.gz", help="matrix file for DGE inside --dge-dir. Must be sorted by barcode index (default by STARsolo)")
parser.add_argument("-b", "--bcd", type=str, default="barcodes.tsv.gz", help="barcode.tsv file for DGE inside --dge-dir. Must be sorted alphabetically (default by STARsolo)")
parser.add_argument("-f", "--ftr", type=str, default="features.tsv.gz", help="features.tsv file for DGE inside --dge-dir")
