...
def getSubset(unspliced,spliced,geneInd,barcode_df,bottom):
    ...
    spliced_pos=spliced_pos.dropna()
    unspliced_pos=unspliced_pos.dropna()
    spliced_pos = spliced_pos.loc[spliced_pos.index.repeat(spliced_pos['umi'])]
    unspliced_pos=unspliced_pos.loc[unspliced_pos.index.repeat(unspliced_pos['umi'])]
    spliced_pos['UMIs']= 1
    unspliced_pos['UMIs']=1
