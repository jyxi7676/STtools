...
#modules                                                                                                                                                                                                
import pip
modules = ["sys","os","gzip","math","random","numpy","pandas","argparse","subprocess","PIL"]
...
if args.inv_weight:
    ...
    for r in range(nrows):
        for c in range(ncols):
            if os.path.isdir(f"{args.in_dir}/{lanes[r][c]}/{tiles[r][c]}")==False:
                print('not exist3')
                continue
            print('here3')
...
for r in range(nrows):
    for c in range(ncols):
        ...
        print('here')
        print(f"{args.in_dir}/{lanes[r][c]}/{tiles[r][c]}/features.tsv.gz")
        if os.path.isdir(f"{args.in_dir}/{lanes[r][c]}/{tiles[r][c]}")==False:
            print('not exist')
            continue
        print('here2')
